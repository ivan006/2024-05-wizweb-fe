...
export default class DBBaseModel extends Model {
    ...
    static customSupabaseApiFetchAll(
        ...
        return this.customApiBase(headers).get(computedUrl, {
    ...
    static customSupabaseApiFetchById(
        url,
        id,
        relationships = [],
        flags = {},
    ...
    static customSupabaseApiStore(
        ...
        return this.customApiBase(headers).post(
            url,
            { ...entity },
            {
                dataTransformer: ({ data }) => {
    ...
    static customSupabaseApiUpsert(
        url,
        entity,
        relationships = [],
        flags = {},
    ...
    static customSupabaseApiUpdate(
        url,
        entity,
        relationships = [],
        flags = {},
        ...
        return this.customApiBase(headers).patch(
            computedUrl,
            { ...entity },
            {
                dataTransformer: ({ data }) => {
    ...
    static customSupabaseApiDelete(
        url,
        entityId,
        flags = {},
        headers = {},
        ...
        return this.customApiBase(headers).delete(computedUrl, {
            delete: entityId,
        });
        // .then((res) => {
        //     CustonMixins.methods.logNetworkSuccess(res)
