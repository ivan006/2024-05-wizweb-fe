        ...
        <template v-for="field in superOptions.modelFields" :key="field.name">
          <div>
            ...
            <template v-else-if="field.usageType.startsWith('rel')">
              <template v-if="field.usageType.startsWith('relLookup')">
                <!--                                                  <RelationComponent-->
                <!--                                                      :configs="field"-->
              ...
              <template
                  v-else-if="field.usageType.startsWith('relForeignKeyNormal')"
              >
                <!--                              <pre>{{field.usageType }}</pre>-->
              ...
              <template
                  v-else-if="
                  field.usageType.startsWith('relForeignKeyMapExtraRel')
                "
              >
                <RelationComponent
                    :configs="field"
              ...
              <template v-else-if="field.usageType.startsWith('relChildren')">
              </template>
