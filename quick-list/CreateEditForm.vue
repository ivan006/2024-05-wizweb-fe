...
<script>
import RelationComponent from '@/views/global/quick-list/RelationComponent.vue'
import DateAndTimeRangePicker from '@/views/global/quick-list/DateAndTimeRangePicker.vue'
import DateAndTimePicker from '@/views/global/quick-list/DateAndTimePicker.vue'
import moment from 'moment/moment'
import SearchGooglePlace from '@/views/global/quick-list/SearchGooglePlace.vue'
